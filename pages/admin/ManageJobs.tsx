      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="text" name="taskUrl" value={newJob.taskUrl || ''} onChange={handleInputChange} placeholder="http://example.com" className="mt-1 block w-full p-2 border border-gray-300 rounded-md"/>
          </div>
          <div>
             ...
             <div className="space-y-4 mt-4">
                {proofsConfig.map((config, index) => (
                    <div key={index} className="border p-4 rounded-md space-y-3 bg-slate-50">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Proof Instruction</label>
                            <input 
                                type="text" 
                                placeholder={config.type === 'image' ? "যেমন: কাজের স্ক্রিনশট দিন" : "যেমন: আপনার ফেসবুক নাম দিন"}
                                value={config.label} 
